...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/KBContactsSelection/KBContactsSelection.framework"
  install_framework "$BUILT_PRODUCTS_DIR/KNSemiModalViewController_hons82/KNSemiModalViewController_hons82.framework"
  install_framework "$BUILT_PRODUCTS_DIR/MBLocationManager/MBLocationManager.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/UITableView+Placeholder/UITableView_Placeholder.framework"
fi
